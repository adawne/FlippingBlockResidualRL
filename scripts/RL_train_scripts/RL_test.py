...
def manual_test():
    ...
    for episode in range(num_episodes):
        ...
        for step in range(max_steps_per_episode):
            ...
            # print(f"Qpos: {observation[:3]} | Qvel: {observation[3:6]} | EE height: {observation[12]} | EE quat: {observation[13:17]} | EE transvel: {observation[17:20]} | EE angvel: {observation[20:23]}") 
